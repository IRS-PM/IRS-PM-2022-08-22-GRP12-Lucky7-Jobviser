    ...
    > -->
      ...
      <v-row>
        <v-col class="text-center" cols="12">
          <h1>Career Guidance and Analysis System</h1>
          <v-divider></v-divider>
        </v-col>
      </v-row>
      <v-row
        ...
        <v-form>
          <v-container>
              <v-text-field
                ...
                required
                maxlength="25"
                hint="Please use characters and numbers only"
      ...
      >
        <v-checkbox
          v-model="checkbox"
          :label="`This project may contain MBTI-related analysis, please be informed.`"
          color= #7aafa1
        ></v-checkbox>
      </v-row>
      <h1><br></h1>
      ...
      >
        <v-hover
          ...
          <v-btn
            ...
            disabled
            x-large
          >Please input your name and agree the term
          </v-btn>
          <v-btn
            v-else
            ...
            color= #82A5D2
            x-large
            v-on:click="submit">Start the Questionnaire{{ "\xa0\xa0" }}
            <v-icon>mdi-pencil</v-icon>
          </v-btn>
        </v-hover>
      </v-row>
      <h1><br></h1>
      <h4>Copyright ©️ 2022 Lucky7</h4>
    <!-- </v-parallax> -->
  </v-app>
</template>
